...
public class OpenRouterAIService {
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("- Keep it lengthy but no out of the context words keep it relevant\n");
        prompt.append("- Do not include any explanations or metadata.\n");
    ...
    private String getToneDesc(String tone) {
        return switch (tone.toLowerCase()) {
            case "casual" -> "Casual and relaxed. Use informal language and a friendly conversational style.";
            case "professional" -> "Professional and formal. Use proper grammar and business-appropriate language.";
            case "friendly" -> "Warm and friendly. Be personable, positive, and approachable.";
            case "aggressive" -> "Direct and assertive. Be firm and to the point, but remain professional.";
    ...
    private Map<String, Object> buildRequestBody(String prompt) {
        ...
        systemMessage.put("content", "You are an email assistant that generates appropriate email replies. Respond with just the email content, no explanations.");
